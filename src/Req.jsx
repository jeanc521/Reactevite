...
export default function Req(){
    ...
    return(
            ...
            <input type="text" placeholder='Digite uma pagina 1 a 42' value={page} onChange={(e) => setPage(e.target.value)}/>
            {erro && <p>Pagina nao encontrada</p>}

      
        <input style={{padding: "10px"}} type="text" placeholder='Digite um nome' value={searchName} onChange={(e) => setSearchName(e.target.value)} />
